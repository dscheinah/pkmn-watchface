...
var component = {
    ...
    style:
        ...
        '.pokedex div { margin: .25rem; display: flex; align-items: center; justify-content: center; background: white; border-radius: .25rem; width: 64px; height: 64px; border: 3px solid white; }' +
