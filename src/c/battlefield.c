...
static void renderBattlefield(Layer *layer, GContext *ctx) {
...
void battlefield_load(Layer *root, Ally *ally, Enemy *enemy) {
  ...
  battlefield = layer_create(bounds);
  layer_add_child(root, battlefield);
  ...
  layer_add_child(battlefield, bitmap_layer_get_layer(allyPart.image));
  layer_add_child(battlefield, text_layer_get_layer(allyPart.level));
  layer_add_child(battlefield, allyPart.health);
  layer_add_child(battlefield, allyPart.experience);
  ...
  layer_add_child(battlefield, bitmap_layer_get_layer(enemyPart.image));
  layer_add_child(battlefield, text_layer_get_layer(enemyPart.level));
  layer_add_child(battlefield, enemyPart.health);

  layer_set_update_proc(battlefield, renderBattlefield);
